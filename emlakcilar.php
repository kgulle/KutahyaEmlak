        ...
        <section class="generalwrapper dm-shadow clearfix">
        	<div class="container">
				<div class="row">
                	...
                	<div id="content" class="col-lg-10 col-md-9 col-sm-9 col-xs-12 clearfix">
	
	
	
	<?php 
							$sorgu=$veritabani->prepare("select*from emlakcilar");
							$sorgu->execute();
							//
							while($sonuc=$sorgu->fetch()){
							...
							?>
                                ...
                                <div class="col-lg-3">
                                    <div class="image">
                                        <img class="img-responsive img-thumbnail" src="<?php echo "yonetim/".$logo_url; ?>" alt="<?php echo $ad; ?>">
                                    </div><!-- end agencies img -->
                                </div>
                                <div class="col-lg-9">
                                    <div class="agencies_desc">
                                        <h3 class="title"><?php echo $ad; ?></h3>
                                        <p><?php echo $hakkinda; ?></p>
                                        <a href="emlakci_hakkinda.php?emlakci_id=<?php echo $emlakci_id; ?>" class="btn btn-primary btn-sm">Hakkımda</a>
										<a href="emlakci_ilanlari.php?emlakci_id=<?php echo $emlakci_id; ?>" class="btn btn-primary btn-sm">İlanlarım</a>
                                        
                                    </div><!-- agencies_desc -->
                                </div>
                                <div class="clearfix"></div>
                                <div class="agencies_meta">
									<span><i class="fa fa-envelope"></i> <?php echo $eposta; ?></span>             
                                    <span><i class="fa fa-phone-square"></i> <?php echo $telefon; ?></span>
									 <span><i class="fa fa-calendar"></i> <?php echo $kayit_tarihi; ?></span>
