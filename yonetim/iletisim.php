<?php
	...
	//okunmamis sql
	$sorgu5=$veritabani->prepare("
	SELECT * FROM iletisim WHERE okundu=0 and silindi=0");
	$sorgu5->execute();
	$okunmayan_mesaj_sayi = $sorgu5->rowCount();
		}
?>
<!DOCTYPE html>
<html>
							...
							<div class="row">
									...
									<div class="box box-solid">
										...
										<div class="box-body no-padding">
											<ul class="nav nav-pills nav-stacked">
												...
												<li <?php if ($goster=="okunmamis") echo "class='active'"; ?>><a href="iletisim.php?goster=okunmamis"><i class="fa fa-inbox"></i> Okunmamış <span class="label label-primary pull-right"><?php echo $okunmayan_mesaj_sayi ; ?></span></a></li>
								...
								<div class="col-md-9">
									<div class="box box-primary">
										<div class="box-header with-border">
											<h3 class="box-title"> <?php if ($goster=="copkutusu") echo " Çöp Kutusu"; elseif($goster=="okunmamis") echo "Okunmamiş iletisim"; else echo "Gelen Kutusu"; ?></h3>
														...
														<?php 
															if ($goster=="copkutusu") {
																while($sonuc=$sorgu2->fetch()){
																	...
																	$okundu=$sonuc['okundu'];
																	echo "<tr>
																	<td class='mailbox-star'><a href='iletisim_oku.php?islem=kalicisil&mesaj_id=$mesaj_id'><i class='fa fa-trash-o'></i></a></td>
																	<td class='mailbox-name'><a href='iletisim_oku.php?mesaj_id=$mesaj_id'>"; 
															...
															elseif($goster=="okunmamis") {
																while($sonuc=$sorgu4->fetch()){
																	...
																	$okundu=$sonuc['okundu'];
																	echo "<tr>
																	<td class='mailbox-star'><a href='iletisim_oku.php?islem=sil&mesaj_id=$mesaj_id'><i class='fa fa-trash-o'></i></a></td>
																	<td class='mailbox-name'><a href='iletisim_oku.php?mesaj_id=$mesaj_id'>"; 
																	if($okundu==0) echo "<b> $gonderen_ad </b>"; else echo "$gonderen_ad";
																	echo "</a></td>
																	<td class='mailbox-attachment'>"; 
